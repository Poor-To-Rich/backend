...
public enum UserResponse implements Response {
    ...
    USERNAME_NOT_RESERVED(HttpStatus.BAD_REQUEST, UserResponseMessages.USERNAME_NOT_RESERVED),
    ...
    NICKNAME_NOT_RESERVED(HttpStatus.BAD_REQUEST, UserResponseMessages.NICKNAME_NOT_RESERVED),
