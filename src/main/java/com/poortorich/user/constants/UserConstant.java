...
public class UserConstant {
    ...
    public static final class ValidationMessages {
        ...
        public static final String NAME_REQURIED = "이름을 입력해주세요.";
        ...
        public static final String NICKNAME_REQURIED = "닉네임을 입력해주세요.";
        ...
        public static final String USERNAME_REQURIED = "아이디를 입력해주세요.";
    ...
    public static final class ValidationSize {
