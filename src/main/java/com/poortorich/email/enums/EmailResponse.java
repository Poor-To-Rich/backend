...
public enum EmailResponse implements Response {
    ...
    INVALID_PURPOSE(HttpStatus.BAD_REQUEST, EmailResponseMessage.INVALID_PURPOSE),
    INVALID_VERIFICATION_CODE(HttpStatus.BAD_REQUEST, EmailResponseMessage.INVALID_VERIFICATION_CODE),
    ...
    INVALID_EMAIL(HttpStatus.BAD_REQUEST, EmailResponseMessage.INVALID_EMAIL),
    ...
    TOO_MANY_REQUEST_EMAIL(HttpStatus.TOO_MANY_REQUESTS, EmailResponseMessage.TOO_MANY_REQUEST_EMAIL),
