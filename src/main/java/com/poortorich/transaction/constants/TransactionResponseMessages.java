package com.poortorich.transaction.constants;
...
public class TransactionResponseMessages {
    ...
    public static final String GET_YEARLY_TOTAL_SUCCESS = "월별 수입/지출 명세를 성공적으로 조회하였습니다.";
    public static final String GET_WEEKLY_TOTAL_SUCCESS = "주별 수입/지출 명세를 성공적으로 조회하였습니다.";
    ...
    private TransactionResponseMessages() {
    }
}
