...
public class IterationResponseMessages {
    ...
    public static final String ITERATION_RULE_REQUIRED = "반복 데이터 정보는 필수입니다.";
    public static final String ITERATION_RULE_TYPE_REQUIRED = "반복 데이터 타입은 필수입니다.";
    public static final String ITERATION_RULE_TYPE_INVALID = "반복 타입이 적절하지 않습니다.";

    public static final String DAY_OF_WEEK_INVALID = "요일이 적절하지 않습니다.";
    public static final String DAYS_OF_WEEK_REQUIRED_WEEKLY_TYPE = "매주 반복하는 경우 요일은 필수입니다.";
    ...
    public static final String END_REQUIRED = "반복 종료는 필수입니다.";
    public static final String END_TYPE_REQUIRED = "반복 종료 타입은 필수입니다.";
